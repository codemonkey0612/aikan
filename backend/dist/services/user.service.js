...
const getUsersPaginated = (page, limit, sortBy, sortOrder, filters) => UserModel.getUsersPaginated(page, limit, sortBy, sortOrder, filters);
...
const createUser = (data) => UserModel.createUser(data);
