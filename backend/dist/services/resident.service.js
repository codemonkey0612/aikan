...
const getAllResidents = () => ResidentModel.getAllResidents();
exports.getAllResidents = getAllResidents;
const getResidentById = (resident_id) => ResidentModel.getResidentById(resident_id);
exports.getResidentById = getResidentById;
const createResident = (data) => ResidentModel.createResident(data);
exports.createResident = createResident;
const updateResident = (resident_id, data) => ResidentModel.updateResident(resident_id, data);
exports.updateResident = updateResident;
const deleteResident = (resident_id) => ResidentModel.deleteResident(resident_id);
